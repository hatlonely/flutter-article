...
import 'package:articleapi/src/api_util.dart';
...
class ArticleServiceApi {
  ...
  Future<Response<JsonObject>> articleServiceDelArticle({ 
    required String id,
    ...
    final _path = r'/v1/article/{id}'.replaceAll('{' r'id' '}', id.toString());
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JsonObject>> articleServiceDelAuthor({ 
    String? id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JsonObject>> articleServiceDelAuthorByKey({ 
    ...
    final _path = r'/v1/delAuthorByKey';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiArticle] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ApiArticle>> articleServiceGetArticle({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    ApiArticle _responseData;

    try {
      const _responseType = FullType(ApiArticle);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as ApiArticle;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiListArticleRes] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ApiListArticleRes>> articleServiceListArticle({ 
    int? offset,
    int? limit,
    String? authorID,
    CancelToken? cancelToken,
    ...
    ApiListArticleRes _responseData;

    try {
      const _responseType = FullType(ApiListArticleRes);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as ApiListArticleRes;
    ...
    return Response<ApiListArticleRes>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JsonObject>> articleServicePing({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ApiArticleID>> articleServicePutArticle({ 
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JsonObject>> articleServiceUpdateArticle({ 
    required String id,
    required InlineObject body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
